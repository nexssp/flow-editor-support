...
(cd "$ROOT" && zip -qr "$OUT_DIR/nexss-flow-source.zip" README.md LICENSE assets grammar.js src examples fmt lsp zed zed-legacy-0.230.2 vscode notepadpp claude jetbrains package.json scripts/validate.py .zed .github)
